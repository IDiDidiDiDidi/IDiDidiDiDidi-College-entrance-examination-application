  ...
  <div id="HomePage">
      ...
      <div class="row bigData-container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            山东鑫卓重工机械有限公司
            <small>/ Shan Dong Xin Zhuo Heavy Industry Limited Liability Company</small>
          </h2>
    ...
    <div id="customer" class="container-fuild">
      <div class="container customer-container">
        <p class="customer-title text-center">热门产品</p>
...
export default {
  ...
  data() {
    return {
      ...
      customerList: [
        {
          logo: require("@/assets/img/diaoche/8t_tangjun_1.jpg"),
          title:
            "国六重汽豪沃12吨。",
          content:
            "国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。国六重汽豪沃12吨。"
        },
        {
          logo: require("@/assets/img/diaoche/8t_tangjun_1.jpg"),
          title:
      ...
      serverList: [
        {
          ...
          title: "规格齐全，种类丰富",
          content: "<p>强大的技术团队，不断科技创新</p> &nbsp;  <p>可根据客户需求，专业个性化定制"
        },
        {
          logo: require("@/assets/img/computer.png"),
          title: "性能稳定，操作灵活",
          content: "<p>所有产品都经过多次检验，确保符合出厂要求</p>帮助客户进行调试、解决故障"
        },
        {
          logo: require("@/assets/img/qq.png"),
          title: "发家致富,助力新农村",
          content: "<p>针对乡村建设要求，多样化产品</p>是承揽工程建设和农民朋友发夹致富的首选"
        },
        {
          logo: require("@/assets/img/skill.png"),
          title: "功能强大，作业能力强",
          content: "<p>不断研发，创新</p>采用专用底盘，360度无死角转向工作，满足您的多样化操作需求"
        }
      ]
    };
  },
